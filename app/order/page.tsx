            ...
            <div className="lg:col-span-2 space-y-5">
              ...
              <div className="bg-white border border-gray-100 p-6">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        {product.variants.map((variant) => {
                          ...
                          return (
                            <div
                              key={variant.id}
                              className={`border p-4 transition-all ${qty > 0 ? 'border-mango-300 bg-mango-50/50' : 'border-gray-100 bg-white'}`}
                            >
                ...
                <div className="mt-6 pt-4 border-t border-gray-100">
                  <p className="text-xs text-gray-400 tracking-wide">水蜜桃芒果、烏香芒果目前尚未開放，敬請期待</p>
                </div>
              </div>
              ...
              <div className="bg-white border border-gray-100 p-6">
                ...
                <div className="bg-amber-50 border border-amber-100 p-5 mb-6">
                  ...
                  <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-xs">
                    ...
                    <span className="text-mango-600 font-medium">
                      {total > 0 ? `NT$ ${total.toLocaleString()}` : '依訂單計算'}
                    </span>
                  </div>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              {error && (
                <div className="border border-red-200 bg-red-50 text-red-600 p-4 text-xs tracking-wide">
                  {error}
                </div>
              )}
            </div>
